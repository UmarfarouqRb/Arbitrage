...
export type SolanaTransactionsFilterNested = {
    operation: "AND" | "OR";
    filters: Array<SolanaTransactionsFilterValue | SolanaTransactionsFilterNested>;
};
/**
 * EVM Address
...
export type CancelResult = "CANCELLED_IMMEDIATELY" | "CANCELLATION_PENDING" | {
    CANNOT_CANCEL: {
        reason: string;
    };
} | "NOT_FOUND";
 ...
 */
export type Eip7702ExecutionOptions = Eip7702OwnerExecution | Eip7702SessionKeyExecution;
/**
...
export type RpcErrorKind = (RpcErrorResponse & {
    type: "ERROR_RESP";
}) | {
    type: "NULL_RESP";
} | {
 ...
 */
export type SigningOptions = (EoaSigningOptions & {
    type: "EOA";
 ...
 */
export type SpecificExecutionOptions = (AutoExecutionOptions & {
    type: "auto";
 ...
 */
export type TransactionTypeData = Transaction7702Data | Transaction1559Data | TransactionLegacyData;
...
export type EncodeContractResponse = EncodeContractResponses[keyof EncodeContractResponses];
...
export type SendSolanaTransactionResponse = SendSolanaTransactionResponses[keyof SendSolanaTransactionResponses];
...
export type ListSolanaAccountsResponse = ListSolanaAccountsResponses[keyof ListSolanaAccountsResponses];
...
export type CreateSolanaAccountResponse = CreateSolanaAccountResponses[keyof CreateSolanaAccountResponses];
...
export type SignSolanaMessageResponse = SignSolanaMessageResponses[keyof SignSolanaMessageResponses];
...
export type SignSolanaTransactionResponse = SignSolanaTransactionResponses[keyof SignSolanaTransactionResponses];
...
export type SearchActivityLogsResponse = SearchActivityLogsResponses[keyof SearchActivityLogsResponses];
...
export type GetSolanaTransactionsResponse = GetSolanaTransactionsResponses[keyof GetSolanaTransactionsResponses];
...
export type SearchSolanaTransactionsResponse = SearchSolanaTransactionsResponses[keyof SearchSolanaTransactionsResponses];
...
export type GetSolanaActivityLogsResponse = GetSolanaActivityLogsResponses[keyof GetSolanaActivityLogsResponses];
...
export type SearchSolanaActivityLogsResponse = SearchSolanaActivityLogsResponses[keyof SearchSolanaActivityLogsResponses];
