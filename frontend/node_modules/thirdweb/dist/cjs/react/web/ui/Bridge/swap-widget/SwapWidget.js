...
function SwapWidgetContent(props) {
    ...
    // preload requests
    (0, use_bridge_chains_js_1.useBridgeChains)(props.client);
    ...
    if (screen.id === "2:preview") {
        return ((0, jsx_runtime_1.jsx)(PaymentDetails_js_1.PaymentDetails, { metadata: {
                title: "Review Swap",
                description: undefined,
            }, confirmButtonLabel: "Swap", client: props.client, onBack: () => {
            ...
            }, onError: (error) => handleError(error, screen.preparedQuote), paymentMethod: {
                quote: screen.quote,
                type: "wallet",
                ...
                action: screen.mode,
            }, preparedQuote: screen.preparedQuote, currency: props.currency, modeInfo: {
                mode: "fund_wallet",
            } }));
    }
    ...
    if (screen.id === "4:success") {
        return ((0, jsx_runtime_1.jsx)(SuccessScreen_js_1.SuccessScreen, { client: props.client, completedStatuses: screen.completedStatuses, onDone: () => {
                setScreen({ id: "1:swap-ui" });
                // clear amounts
                setAmountSelection({
                    type: "buy",
