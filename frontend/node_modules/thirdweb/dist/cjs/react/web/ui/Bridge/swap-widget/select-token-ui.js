...
function SelectToken(props) {
    ...
    const [limit, setLimit] = (0, react_1.useState)(1000);
    ...
    if (!isMobile) {
        return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
                ...
                height: "100%",
                            ...
                            props.onClose();
                        }, isMobile: false, selectedToken: props.selectedToken, isFetching: props.isFetching, ownedTokens: props.ownedTokens, otherTokens: sortedOtherTokens, showMore: props.showMore, selectedChain: props.selectedChain, onSelectChain: () => setScreen("select-chain"), client: props.client, search: props.search, setSearch: props.setSearch }) })] }));
    }
    if (screen === "select-token") {
        return ((0, jsx_runtime_1.jsx)(TokenSelectionScreen, { onSelectToken: (token) => {
                props.setSelectedToken(token);
                props.onClose();
            }, selectedToken: props.selectedToken, isFetching: props.isFetching, ownedTokens: props.ownedTokens, otherTokens: sortedOtherTokens, showMore: props.showMore, selectedChain: props.selectedChain, isMobile: true, onSelectChain: () => setScreen("select-chain"), client: props.client, search: props.search, setSearch: props.setSearch }));
    }
...
function TokenSelectionScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { fullHeight: true, flex: "column", children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "md", pt: "md+", children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "lg", weight: 600, color: "primaryText", trackingTight: true, children: "Select Token" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "3xs" }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "secondaryText", multiline: true, style: {
                            textWrap: "pretty",
                            maxWidth: "70%",
                        }, children: "Select a token from the list or search for a token by symbol or address" })] }), !props.selectedChain && ((0, jsx_runtime_1.jsx)("div", { style: {
                    display: "flex",
                    alignItems: "center",
                    ...
                    minHeight: "400px",
                            ...
                            paddingBottom: index_js_1.spacing.md,
                                ...
                                (0, jsx_runtime_1.jsx)(TokenButtonSkeleton, {}, i))), !props.isFetching && props.ownedTokens.length > 0 && ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "xs", py: "xs", flex: "row", gap: "xs", center: "y", color: "secondaryText", children: [(0, jsx_runtime_1.jsx)(WalletDotIcon_js_1.WalletDotIcon, { size: index_js_1.iconSize.xs }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "secondaryText", style: {
                                            overflow: "unset",
                                        }, children: "Your Tokens" })] })), !props.isFetching &&
                                props.ownedTokens.map((token) => ((0, jsx_runtime_1.jsx)(TokenButton, { token: token, client: props.client, onSelect: props.onSelectToken, isSelected: !!props.selectedToken &&
                                ...
                                }, children: [(0, jsx_runtime_1.jsx)(CoinsIcon_js_1.CoinsIcon, { size: index_js_1.iconSize.xs }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "secondaryText", style: {
                                            overflow: "unset",
                                        }, children: "Other Tokens" })] })), !props.isFetching &&
                                props.otherTokens.map((token) => ((0, jsx_runtime_1.jsx)(TokenButton, { token: token, client: props.client, onSelect: props.onSelectToken, isSelected: !!props.selectedToken &&
                                        props.selectedToken.tokenAddress.toLowerCase() ===
                                            token.address.toLowerCase() &&
                                        token.chainId === props.selectedToken.chainId }, token.address))), props.showMore && ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { variant: "secondary", fullWidth: true, onClick: () => {
                                    props.showMore?.();
                                }, children: "Load More" })), noTokensFound && ((0, jsx_runtime_1.jsx)("div", { style: {
                                    flex: 1,
                                    display: "flex",
                                    alignItems: "center",
                                    justifyContent: "center",
                                }, children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "md", color: "secondaryText", children: "No Tokens Found" }) }))] })] }))] }));
}
