...
function SuccessScreen({ preparedQuote, completedStatuses, onDone, windowAdapter, client, hasPaymentId = false, showContinueWithTx, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", fullHeight: true, px: "md", pb: "md", pt: "md+", children: [(0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: "Payment Complete" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "x", flex: "column", gap: "md", children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "both", flex: "row", style: {
                            ...
                            width: "64px",
                                ...
                                }, children: "Payment Successful!" }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { center: true, color: "secondaryText", size: "sm", children: hasPaymentId
                                    ? "You can now close this page and return to the application."
                                    : showContinueWithTx
                                        ? "Click continue to execute your transaction."
                                        : "Your payment has been completed successfully." })] })] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "sm", style: { width: "100%" }, children: [(0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, onClick: () => setViewState("detail"), variant: "secondary", children: "View Payment Receipt" }), !hasPaymentId && ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, onClick: onDone, variant: "accent", children: showContinueWithTx ? "Continue" : "Done" }))] }), (0, jsx_runtime_1.jsx)("style", { children: `
