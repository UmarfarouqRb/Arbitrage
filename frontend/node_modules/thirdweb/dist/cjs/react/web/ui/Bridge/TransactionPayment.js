...
function TransactionPayment({ transaction, client, onContinue, onExecuteTransaction, connectOptions, currency, showThirdwebBranding = true, buttonLabel: _buttonLabel, metadata, }) {
    ...
    if (isLoading) {
        return ((0, jsx_runtime_1.jsxs)(WithHeader_js_1.WithHeader, { client: client, title: metadata.title || "Transaction", description: metadata.description, image: metadata.image, children: [(0, jsx_runtime_1.jsx)(SkeletonHeader, { theme: theme }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(SkeletonRow, { theme: theme, width: "60%" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsx)(SkeletonRow, { theme: theme, width: "40%" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsx)(SkeletonRow, { theme: theme, width: "50%" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsx)(SkeletonRow, { theme: theme, width: "45%" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsx)(SkeletonRow, { theme: theme, width: "55%" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)("div", { style: {
    ...
    return ((0, jsx_runtime_1.jsxs)(WithHeader_js_1.WithHeader, { client: client, title: metadata.title || "Transaction", description: metadata.description, image: metadata.image, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "y", flex: "row", gap: "3xs", style: {
                ...
                }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "xl", weight: 600, children: costToDisplay }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", size: "md", style: {
                ...
                contractName !== "Unknown Contract" && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", style: {
                    ...
                    justifyContent: "space-between",
                            ...
                            textDecoration: "none",
                        }, target: "_blank", children: (0, address_js_1.shortenAddress)(transaction.to) })] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", style: {
                    alignItems: "center",
                    justifyContent: "space-between",
                    ...
                    label: buttonLabel,
                }, theme: theme, ...connectOptions })), showThirdwebBranding ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(PoweredByTW_js_1.PoweredByThirdweb, {})] })) : null, (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" })] }));
}
