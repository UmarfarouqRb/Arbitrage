...
function BuyWidget(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(BridgeWidgetContainer, { theme: props.theme, className: props.className, style: props.style, children: (0, jsx_runtime_1.jsx)(BridgeWidgetContent, { ...props, theme: props.theme || "dark", currency: props.currency || "USD", paymentMethods: props.paymentMethods || ["crypto", "card"], presetOptions: props.presetOptions || [5, 10, 20], connectOptions: connectOptions, showThirdwebBranding: props.showThirdwebBranding === undefined
                ? true
...
function BridgeWidgetContent(props) {
    ...
    if (screen.id === "1:buy-ui") {
        return ((0, jsx_runtime_1.jsx)(FundWallet_js_1.FundWallet, { theme: props.theme, onDisconnect: props.onDisconnect, client: props.client, connectOptions: props.connectOptions, onContinue: (destinationAmount, destinationToken, receiverAddress) => {
                ...
                image: props.image,
            }, buttonLabel: props.buttonLabel, currency: props.currency, selectedToken: selectedToken, setSelectedToken: setSelectedToken, amountSelection: amountSelection, setAmountSelection: setAmountSelection }));
    }
