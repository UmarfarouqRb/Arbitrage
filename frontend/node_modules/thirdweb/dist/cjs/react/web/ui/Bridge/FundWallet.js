...
function FundWallet(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(WithHeader_js_1.WithHeader, { client: props.client, title: props.metadata.title, description: props.metadata.description, image: props.metadata.image, children: [detailsModalOpen && ((0, jsx_runtime_1.jsx)(Details_js_1.DetailsModal, { client: props.client, locale: en_js_1.default, detailsModal: {
                    ...
                    transform: "none",
                }, setOpen: (v) => setIsTokenSelectionOpen(v), autoFocusCrossIcon: false, children: (0, jsx_runtime_1.jsx)(select_token_ui_js_1.SelectToken, { activeWalletInfo: activeWalletInfo, onClose: () => setIsTokenSelectionOpen(false), client: props.client, selectedToken: props.selectedToken, setSelectedToken: (token) => {
                        ...
                        }, currency: props.currency }), receiver && isReceiverDifferentFromActiveWallet && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ArrowSection, {}), (0, jsx_runtime_1.jsx)(ReceiverWalletSection, { address: receiver, client: props.client })] }))] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (tokenQuery.isError ||
                ...
                }, theme: theme, ...props.connectOptions })) : ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { disabled: !receiver, fullWidth: true, onClick: () => {
    ...
    return ((0, jsx_runtime_1.jsxs)(SectionContainer, { header: (0, jsx_runtime_1.jsxs)("div", { style: {
                ...
                alignItems: "center",
                            ...
                            gap: "2px",
                                    ...
                                    height: "20px",
                                    paddingBlock: 0,
                                } }))] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xxs", children: props.presetOptions.map((amount) => ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { disabled: !props.selectedToken?.data, onClick: () => props.setAmount({
                                type: "usd",
                                value: String(amount),
                            }), style: {
