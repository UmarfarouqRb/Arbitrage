...
function PaymentOverview(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { bg: "tertiaryBg", flex: "column", style: {
                    ...
                    borderRadius: index_js_1.radius.lg,
                        ...
                        }, children: (0, jsx_runtime_1.jsx)(WalletRow_js_1.WalletRow, { address: sender, client: props.client, iconSize: "md", textSize: "sm" }) })), props.paymentMethod.type === "wallet" && ((0, jsx_runtime_1.jsx)(TokenBalanceRow_js_1.TokenBalanceRow, { currency: props.currency, amount: props.fromAmount, client: props.client, onClick: () => { }, style: {
...
const TransactionOverViewCompact = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "y", flex: "row", gap: "sm", p: "md", style: { justifyContent: "space-between" }, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "y", flex: "column", gap: "3xs", style: { flex: 1 }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "sm", style: { fontWeight: 600 }, children: props.metadata.title || "Transaction" }), props.metadata.description && ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", size: "xs", children: props.metadata.description }))] }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "y", flex: "column", gap: "3xs", style: { alignItems: "flex-end" }, children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", size: "xs", style: {
