...
const CopyIcon = (props) => {
    ...
    (0, jsx_runtime_1.jsx)("div", { onClick: onCopy, onKeyDown: (e) => {
        ...
        }, children: (0, jsx_runtime_1.jsx)(Tooltip_js_1.ToolTip, { align: props.align, side: props.side, tip: props.tip, children: (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "both", color: showCheckIcon ? "success" : undefined, flex: "row", children: showCheckIcon ? ((0, jsx_runtime_1.jsx)(react_icons_1.CheckIcon, { className: "tw-check-icon", width: props.iconSize || 16, height: props.iconSize || 16 })) : ((0, jsx_runtime_1.jsx)(react_icons_1.CopyIcon, { className: "tw-copy-icon", width: props.iconSize || 16, height: props.iconSize || 16 })) }) }) }) }));
};
