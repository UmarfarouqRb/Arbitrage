...
const ConnectWalletSocialOptions = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", style: {
            position: "relative",
                        ...
                        return ((0, jsx_runtime_1.jsxs)(SocialButton, { className: "tw-social-button", "aria-label": `Login with ${loginMethod}`, "data-variant": showOnlyIcons ? "icon" : "full", disabled: props.disabled, onClick: () => {
                ...
                (inputMode === "email" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { className: "tw-input-container tw-input-container__email", disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { className: "tw-select-button tw-select-button__email", client: props.client, disabled: props.disabled, icon: EmailIcon_js_1.EmailIcon, onClick: () => {
                        setManualInputMode("email");
                    }, title: locale.emailPlaceholder }))), isPhoneEnabled &&
                (inputMode === "phone" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { className: "tw-input-container tw-input-container__phone", allowedSmsCountryCodes: wallet.getConfig()?.auth?.allowedSmsCountryCodes, defaultSmsCountryCode: wallet.getConfig()?.auth?.defaultSmsCountryCode, disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (_input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { className: "tw-select-button tw-select-button__phone", client: props.client, disabled: props.disabled, icon: PhoneIcon_js_1.PhoneIcon, onClick: () => {
                        setManualInputMode("phone");
                    }, title: locale.phonePlaceholder }))), passKeyEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { className: "tw-select-button tw-select-button__passkey", client: props.client, disabled: props.disabled, icon: FingerPrintIcon_js_1.FingerPrintIcon, onClick: () => {
                    handlePassKeyLogin();
                }, title: locale.passkey })), siweEnabled && !props.isLinking && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { className: "tw-select-button tw-select-button__link-wallet", client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
                }, title: locale.signInWithWallet })), guestEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { className: "tw-select-button tw-select-button__guest", client: props.client, disabled: props.disabled, icon: GuestIcon_js_1.GuestIcon, onClick: () => {
                    handleGuestLogin();
                }, title: locale.loginAsGuest })), props.isLinking && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { className: "tw-select-button tw-select-button__link-wallet", client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
