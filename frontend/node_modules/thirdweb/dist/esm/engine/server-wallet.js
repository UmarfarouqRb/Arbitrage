import { isSuccessResponse, sendTransaction, signMessage, signTypedData, } from "@thirdweb-dev/engine";
...
export function serverWallet(options) {
    ...
    return {
        ...
        signMessage: async (data) => {
            ...
            throw new Error(`Failed to sign message: ${stringify(signatureResult?.error) || "Unknown error"}`);
        },
