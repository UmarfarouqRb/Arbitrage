...
export const ConnectWalletSocialOptions = (props) => {
    ...
    return (_jsxs(Container, { flex: "column", gap: "md", style: {
            position: "relative",
                        ...
                        return (_jsxs(SocialButton, { className: "tw-social-button", "aria-label": `Login with ${loginMethod}`, "data-variant": showOnlyIcons ? "icon" : "full", disabled: props.disabled, onClick: () => {
                ...
                (inputMode === "email" ? (_jsx(InputSelectionUI, { className: "tw-input-container tw-input-container__email", disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (input) => {
                ...
                (inputMode === "phone" ? (_jsx(InputSelectionUI, { className: "tw-input-container tw-input-container__phone", allowedSmsCountryCodes: wallet.getConfig()?.auth?.allowedSmsCountryCodes, defaultSmsCountryCode: wallet.getConfig()?.auth?.defaultSmsCountryCode, disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (_input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : (_jsx(WalletTypeRowButton, { className: "tw-select-button tw-select-button__phone", client: props.client, disabled: props.disabled, icon: PhoneIcon, onClick: () => {
                        setManualInputMode("phone");
                    }, title: locale.phonePlaceholder }))), passKeyEnabled && (_jsx(WalletTypeRowButton, { className: "tw-select-button tw-select-button__passkey", client: props.client, disabled: props.disabled, icon: FingerPrintIcon, onClick: () => {
                    handlePassKeyLogin();
                }, title: locale.passkey })), siweEnabled && !props.isLinking && (_jsx(WalletTypeRowButton, { className: "tw-select-button tw-select-button__link-wallet", client: props.client, icon: OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
                }, title: locale.signInWithWallet })), guestEnabled && (_jsx(WalletTypeRowButton, { className: "tw-select-button tw-select-button__guest", client: props.client, disabled: props.disabled, icon: GuestIcon, onClick: () => {
                    handleGuestLogin();
                }, title: locale.loginAsGuest })), props.isLinking && (_jsx(WalletTypeRowButton, { className: "tw-select-button tw-select-button__link-wallet", client: props.client, icon: OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
