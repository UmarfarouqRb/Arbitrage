...
export function TransactionPayment({ transaction, client, onContinue, onExecuteTransaction, connectOptions, currency, showThirdwebBranding = true, buttonLabel: _buttonLabel, metadata, }) {
    ...
    return (_jsxs(WithHeader, { client: client, title: metadata.title || "Transaction", description: metadata.description, image: metadata.image, children: [_jsxs(Container, { center: "y", flex: "row", gap: "3xs", style: {
                ...
                }, children: [_jsx(Text, { color: "primaryText", size: "xl", weight: 600, children: costToDisplay }), _jsx(Text, { color: "secondaryText", size: "md", style: {
                ...
                contractName !== "Unknown Contract" && (_jsxs(_Fragment, { children: [_jsxs(Container, { flex: "row", style: {
                    ...
                    justifyContent: "space-between",
                            ...
                            textDecoration: "none",
                        }, target: "_blank", children: shortenAddress(transaction.to) })] }), _jsx(Spacer, { y: "xs" }), _jsxs(Container, { flex: "row", style: {
                    alignItems: "center",
                    justifyContent: "space-between",
                    ...
                    label: buttonLabel,
                }, theme: theme, ...connectOptions })), showThirdwebBranding ? (_jsxs("div", { children: [_jsx(Spacer, { y: "md" }), _jsx(PoweredByThirdweb, {})] })) : null, _jsx(Spacer, { y: "md" })] }));
}
