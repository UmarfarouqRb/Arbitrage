...
function TokenSelectionScreen(props) {
    ...
    return (_jsxs(Container, { fullHeight: true, flex: "column", children: [_jsxs(Container, { px: "md", pt: "md+", children: [_jsx(Text, { size: "lg", weight: 600, color: "primaryText", trackingTight: true, children: "Select Token" }), _jsx(Spacer, { y: "3xs" }), _jsx(Text, { size: "xs", color: "secondaryText", multiline: true, style: {
                            textWrap: "pretty",
                            maxWidth: "70%",
                    ...
                    minHeight: "400px",
                            ...
                            paddingBottom: spacing.md,
                                ...
                                _jsx(TokenButtonSkeleton, {}, i))), !props.isFetching && props.ownedTokens.length > 0 && (_jsxs(Container, { px: "xs", py: "xs", flex: "row", gap: "xs", center: "y", color: "secondaryText", children: [_jsx(WalletDotIcon, { size: iconSize.xs }), _jsx(Text, { size: "sm", color: "secondaryText", style: {
                                            overflow: "unset",
                                ...
                                }, children: [_jsx(CoinsIcon, { size: iconSize.xs }), _jsx(Text, { size: "sm", color: "secondaryText", style: {
                                            overflow: "unset",
                                ...
                                props.otherTokens.map((token) => (_jsx(TokenButton, { token: token, client: props.client, onSelect: props.onSelectToken, isSelected: !!props.selectedToken &&
                                    ...
                                    props.showMore?.();
                                }, children: "Load More" })), noTokensFound && (_jsx("div", { style: {
                                    flex: 1,
                                    display: "flex",
                                    alignItems: "center",
                                    justifyContent: "center",
                                }, children: _jsx(Text, { size: "md", color: "secondaryText", children: "No Tokens Found" }) }))] })] }))] }));
}
