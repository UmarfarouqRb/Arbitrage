...
export function SelectedTokenButton(props) {
    ...
    return (_jsxs(Button, { variant: "ghost-solid", hoverBg: "secondaryButtonBg", fullWidth: true, onClick: props.onSelectToken, gap: "sm", style: {
            ...
            borderRadius: 0,
                                    ...
                                    borderRadius: radius.full,
                                        ...
                                        borderRadius: radius.full,
                                    } }) }))] }), props.selectedToken && !props.selectedToken.isError ? (_jsxs(Container, { flex: "column", style: { gap: "3px" }, children: [props.selectedToken?.isFetching ? (_jsx(Skeleton, { width: "60px", height: fontSize.md })) : (_jsx(Text, { size: "md", color: "primaryText", weight: 500, children: props.selectedToken?.data?.symbol })), props.chain ? (_jsx(Text, { size: "xs", color: "secondaryText", style: {
                                    overflow: "hidden",
                                    textOverflow: "ellipsis",
                                    whiteSpace: "nowrap",
                                }, children: cleanedChainName(props.chain.name) })) : (_jsx(Skeleton, { width: "140px", height: fontSize.sm }))] })) : (_jsxs(Container, { flex: "column", style: { gap: "3px" }, children: [_jsx(Text, { size: "md", color: "primaryText", weight: 500, children: "Select Token" }), _jsx(Text, { size: "xs", color: "secondaryText", children: "Required" })] }))] }), _jsx(Container, { color: "secondaryText", flex: "row", center: "both", borderColor: "borderColor", style: {
                    borderRadius: radius.full,
                    borderWidth: 1,
                    borderStyle: "solid",
                    padding: spacing.xs,
