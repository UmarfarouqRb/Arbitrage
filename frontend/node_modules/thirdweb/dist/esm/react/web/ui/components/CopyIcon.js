...
export const CopyIcon = (props) => {
    ...
    _jsx("div", { onClick: onCopy, onKeyDown: (e) => {
        ...
        }, children: _jsx(ToolTip, { align: props.align, side: props.side, tip: props.tip, children: _jsx("div", { children: _jsx(Container, { center: "both", color: showCheckIcon ? "success" : undefined, flex: "row", children: showCheckIcon ? (_jsx(CheckIcon, { className: "tw-check-icon", width: props.iconSize || 16, height: props.iconSize || 16 })) : (_jsx(CopyIconSVG, { className: "tw-copy-icon", width: props.iconSize || 16, height: props.iconSize || 16 })) }) }) }) }));
};
