...
export function FundWallet(props) {
    ...
    return (_jsxs(WithHeader, { client: props.client, title: props.metadata.title, description: props.metadata.description, image: props.metadata.image, children: [detailsModalOpen && (_jsx(DetailsModal, { client: props.client, locale: connectLocaleEn, detailsModal: {
                    ...
                    top: spacing["md+"],
                    transform: "none",
                }, setOpen: (v) => setIsTokenSelectionOpen(v), autoFocusCrossIcon: false, children: _jsx(SelectToken, { activeWalletInfo: activeWalletInfo, onClose: () => setIsTokenSelectionOpen(false), client: props.client, selectedToken: props.selectedToken, setSelectedToken: (token) => {
                        ...
                        }, currency: props.currency }), receiver && isReceiverDifferentFromActiveWallet && (_jsxs(_Fragment, { children: [_jsx(ArrowSection, {}), _jsx(ReceiverWalletSection, { address: receiver, client: props.client })] }))] }), _jsx(Spacer, { y: "md" }), (tokenQuery.isError ||
                ...
                }, theme: theme, ...props.connectOptions })) : (_jsx(Button, { disabled: !receiver, fullWidth: true, onClick: () => {
    ...
    return (_jsxs(SectionContainer, { header: _jsxs("div", { style: {
                ...
                alignItems: "center",
                            ...
                            gap: "2px",
                                    ...
                                    height: "20px",
                                    paddingBlock: 0,
                                } }))] }), _jsx(Spacer, { y: "md" }), _jsx(Container, { flex: "row", gap: "xxs", children: props.presetOptions.map((amount) => (_jsxs(Button, { disabled: !props.selectedToken?.data, onClick: () => props.setAmount({
                                type: "usd",
                                value: String(amount),
                            }), style: {
