...
export function PaymentOverview(props) {
    ...
    return (_jsxs(Container, { children: [_jsxs(Container, { bg: "tertiaryBg", flex: "column", style: {
                    ...
                    borderRadius: radius.lg,
                        ...
                        }, children: _jsx(WalletRow, { address: sender, client: props.client, iconSize: "md", textSize: "sm" }) })), props.paymentMethod.type === "wallet" && (_jsx(TokenBalanceRow, { currency: props.currency, amount: props.fromAmount, client: props.client, onClick: () => { }, style: {
...
const TransactionOverViewCompact = (props) => {
    ...
    return (_jsxs(Container, { center: "y", flex: "row", gap: "sm", p: "md", style: { justifyContent: "space-between" }, children: [_jsxs(Container, { center: "y", flex: "column", gap: "3xs", style: { flex: 1 }, children: [_jsx(Text, { color: "primaryText", size: "sm", style: { fontWeight: 600 }, children: props.metadata.title || "Transaction" }), props.metadata.description && (_jsx(Text, { color: "secondaryText", size: "xs", children: props.metadata.description }))] }), _jsx(Container, { center: "y", flex: "column", gap: "3xs", style: { alignItems: "flex-end" }, children: _jsx(Text, { color: "secondaryText", size: "xs", style: {
