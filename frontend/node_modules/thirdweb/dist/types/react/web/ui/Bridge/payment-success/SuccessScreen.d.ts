...
export declare function SuccessScreen({ preparedQuote, completedStatuses, onDone, windowAdapter, client, hasPaymentId, showContinueWithTx, }: SuccessScreenProps): import("react/jsx-runtime").JSX.Element;
export {};
