  ...
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/_u64.js"(exports) {
    ...
    function split2(lst, le = false) {
      ...
      for (let i3 = 0; i3 < len; i3++) {
        const { h: h3, l: l3 } = fromBig2(lst[i3], le);
        [Ah[i3], Al[i3]] = [h3, l3];
      }
      return [Ah, Al];
    }
    var toBig = (h3, l3) => BigInt(h3 >>> 0) << _32n2 | BigInt(l3 >>> 0);
    exports.toBig = toBig;
    var shrSH2 = (h3, _l, s3) => h3 >>> s3;
    exports.shrSH = shrSH2;
    var shrSL2 = (h3, l3, s3) => h3 << 32 - s3 | l3 >>> s3;
    exports.shrSL = shrSL2;
    var rotrSH2 = (h3, l3, s3) => h3 >>> s3 | l3 << 32 - s3;
    exports.rotrSH = rotrSH2;
    var rotrSL2 = (h3, l3, s3) => h3 << 32 - s3 | l3 >>> s3;
    exports.rotrSL = rotrSL2;
    var rotrBH2 = (h3, l3, s3) => h3 << 64 - s3 | l3 >>> s3 - 32;
    exports.rotrBH = rotrBH2;
    var rotrBL2 = (h3, l3, s3) => h3 >>> s3 - 32 | l3 << 64 - s3;
...
function Chi(a3, b, c3) {
  return a3 & b ^ ~a3 & c3;
}
function Maj(a3, b, c3) {
  return a3 & b ^ a3 & c3 ^ b & c3;
}
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/esm/_u64.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/esm/sha2.js
...
var SHA256 = class extends HashMD {
  ...
  get() {
    const { A: A2, B: B3, C: C3, D: D3, E: E2, F: F2, G: G2, H } = this;
    return [A2, B3, C3, D3, E2, F2, G2, H];
  }
  // prettier-ignore
  set(A2, B3, C3, D3, E2, F2, G2, H) {
    this.A = A2 | 0;
    this.B = B3 | 0;
    this.C = C3 | 0;
    this.D = D3 | 0;
  ...
  process(view, offset) {
    ...
    let { A: A2, B: B3, C: C3, D: D3, E: E2, F: F2, G: G2, H } = this;
    for (let i3 = 0; i3 < 64; i3++) {
      const sigma1 = rotr(E2, 6) ^ rotr(E2, 11) ^ rotr(E2, 25);
      const T1 = H + sigma1 + Chi(E2, F2, G2) + SHA256_K[i3] + SHA256_W[i3] | 0;
      const sigma0 = rotr(A2, 2) ^ rotr(A2, 13) ^ rotr(A2, 22);
      const T2 = sigma0 + Maj(A2, B3, C3) | 0;
      H = G2;
      G2 = F2;
      F2 = E2;
      E2 = D3 + T1 | 0;
    ...
    G2 = G2 + this.G | 0;
    H = H + this.H | 0;
    this.set(A2, B3, C3, D3, E2, F2, G2, H);
  }
  roundClean() {
    clean(SHA256_W);
  }
...
@noble/hashes/esm/utils.js:
  (*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=dist-5SQRYPDZ.js.map
