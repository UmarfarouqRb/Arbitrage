...
async function resolveAbiFromBytecode(contract) {
  const [{ resolveImplementation }, { extractIPFSUri }] = await Promise.all([
    import("./resolveImplementation-NGPJWVCJ.js"),
    import("./extractIPFS-XQATCJPG.js")
  ]);
...
async function resolvePluginPatternAddresses(contract) {
  try {
    const { readContract } = await import("./read-contract-E7VHLJ6L.js");
...
async function resolveModularModuleAddresses(contract) {
  try {
    const { getInstalledModules } = await import("./getInstalledModules-UDHZNJXY.js");
...
async function estimateGas2(options) {
  ...
  const promise = (async () => {
    ...
    const { encode } = await import("./encode-463EU25G.js");
    ...
    const [{ getRpcClient: getRpcClient2 }, { eth_estimateGas }] = await Promise.all([
      import("./rpc-ZZ4AE7L2.js"),
      import("./eth_estimateGas-MKGCOKCD.js")
    ]);
...
//# sourceMappingURL=chunk-J6NIOEGA.js.map
