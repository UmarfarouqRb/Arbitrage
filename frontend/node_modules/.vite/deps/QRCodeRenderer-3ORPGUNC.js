...
function QRCodeRenderer({ ecl = "M", size: sizeProp = 200, uri, clearSize = 0, image, imageBackground = "transparent" }) {
  ...
  const dots = (0, import_react.useMemo)(() => {
    ...
    for (const { x, y } of qrList) {
      ...
      for (let i = 0; i < 3; i++) {
        dotsArray.push((0, import_jsx_runtime.jsx)("rect", { fill: i % 2 !== 0 ? "var(--ck-qr-background, var(--ck-body-background))" : "var(--ck-qr-dot-color)", height: cellSize * (7 - i * 2), rx: (i - 2) * -5 + (i === 0 ? 2 : 3), ry: (i - 2) * -5 + (i === 0 ? 2 : 3), width: cellSize * (7 - i * 2), x: x1 + cellSize * i, y: y1 + cellSize * i }, `${i}-${x}-${y}`));
      }
    }
    if (image) {
      const x1 = (matrix.length - 7) * cellSize * 1;
      const y1 = (matrix.length - 7) * cellSize * 1;
      dotsArray.push((0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("rect", { fill: imageBackground, height: cellSize * (7 - 0 * 2), rx: (0 - 2) * -5 + 2, ry: (0 - 2) * -5 + 2, width: cellSize * (7 - 0 * 2), x: x1 + cellSize * 0, y: y1 + cellSize * 0 }), (0, import_jsx_runtime.jsx)("foreignObject", { height: cellSize * (7 - 0 * 2), width: cellSize * (7 - 0 * 2), x: x1 + cellSize * 0, y: y1 + cellSize * 0, children: (0, import_jsx_runtime.jsx)("div", { style: { borderRadius: (0 - 2) * -5 + 2, overflow: "hidden" }, children: image }) })] }));
    }
  ...
  return (0, import_jsx_runtime.jsxs)("svg", { height: size, role: "presentation", style: {
    height: size,
    width: size
  }, viewBox: `0 0 ${size} ${size}`, width: size, children: [(0, import_jsx_runtime.jsx)("rect", { fill: "transparent", height: size, width: size }), dots] });
}
var QRCodeRenderer_default = QRCodeRenderer;
export {
  QRCodeRenderer_default as default
};
//# sourceMappingURL=QRCodeRenderer-3ORPGUNC.js.map
