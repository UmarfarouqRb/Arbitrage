...
var NATIVE_CURRENCY_SCHEMA = external_exports.object({
  name: external_exports.string().default("Ether"),
  symbol: external_exports.string().default("ETH"),
  decimals: external_exports.number().default(18)
}).default({
  name: "Ether",
  symbol: "ETH",
  decimals: 18
...
async function getCurrencyMetadata(options) {
  if (isNativeTokenAddress(options.contract.address)) {
    if (!options.contract.chain.nativeCurrency || !options.contract.chain.nativeCurrency.name || !options.contract.chain.nativeCurrency.symbol || !options.contract.chain.nativeCurrency.decimals) {
      try {
        const { getChainMetadata } = await import("./utils-2PQBIPGK.js");
...
//# sourceMappingURL=chunk-HJ6MCRWL.js.map
