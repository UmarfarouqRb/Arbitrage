import{q as p,o as u,R as f,M as g,x as a}from"./index-3lbi0dXR.js";import{n as b,r as m,c as w}from"./index-B6cO4qdv.js";import{T as l}from"./index-2GjDrxeF.js";const C={interpolate(r,e,t){if(r.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const o=r[0]||0,i=r[1]||0,n=e[0]||0,s=e[1]||0;return t<o?n:t>i?s:(s-n)/(i-o)*(t-o)+n}},M=p`
  :host {
    width: 100%;
    display: block;
  }
