import{q as U,o as h,M as k,O as H,x as c,F as V,T as z,a0 as F,m as R,r as P,n as M,e as E,a1 as w,C as $,a as I,u as D,E as C,y as _,W as A,S as Y,R as K}from"./index-BqXcWhvD.js";import{r as y,c as f,n as l}from"./index-BoO9KiEv.js";import"./index-m9IgNApp.js";import{e as G,n as L}from"./ref-D8SQPLZ7.js";import"./index-CDHthO9Z.js";import{H as T}from"./HelpersUtil-Dgtjutob.js";import{o as q}from"./if-defined-DyAY53zS.js";import"./index-C-72wguw.js";import"./index-BvtylDfh.js";import"./index-Bgq5GX5f.js";import"./index-CAGpCyno.js";import"./index-CRI2qNeU.js";import{N as X}from"./NavigationUtil-DmfK5sOV.js";import"./index-Dkjnur5k.js";const Q=U`
  div {
    width: 100%;
  }
...
`;var B=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};const N=600,W=360,Z=64;let S=class extends h{constructor(){super(),this.bodyObserver=void 0,this.unsubscribe=[],this.iframe=document.getElementById("w3m-iframe"),this.ready=!1,this.unsubscribe.push(k.subscribeKey("open",t=>{t||this.onHideIframe()}),k.subscribeKey("shake",t=>{t?this.iframe.style.animation="w3m-shake 500ms var(--apkt-easings-ease-out-power-2)":this.iframe.style.animation="none"}))}disconnectedCallback(){var t;this.onHideIframe(),this.unsubscribe.forEach(i=>i()),(t=this.bodyObserver)==null||t.unobserve(window.document.body)}async firstUpdated(){var i;await this.syncTheme(),this.iframe.style.display="block";const t=(i=this==null?void 0:this.renderRoot)==null?void 0:i.querySelector("div");this.bodyObserver=new ResizeObserver(r=>{var s,a;const n=(s=r==null?void 0:r[0])==null?void 0:s.contentBoxSize,o=(a=n==null?void 0:n[0])==null?void 0:a.inlineSize;this.iframe.style.height=`${N}px`,t.style.height=`${N}px`,H.state.enableEmbedded?this.updateFrameSizeForEmbeddedMode():o&&o<=430?(this.iframe.style.width="100%",this.iframe.style.left="0px",this.iframe.style.bottom="0px",this.iframe.style.top="unset",this.onShowIframe()):(this.iframe.style.width=`${W}px`,this.iframe.style.left=`calc(50% - ${W/2}px)`,this.iframe.style.top=`calc(50% - ${N/2}px + ${Z/2}px)`,this.iframe.style.bottom="unset",this.onShowIframe())}),this.bodyObserver.observe(window.document.body)}render(){return c`<div data-ready=${this.ready} id="w3m-frame-container"></div>`}onShowIframe(){const t=window.innerWidth<=430;this.ready=!0,this.iframe.style.animation=t?"w3m-iframe-zoom-in-mobile 200ms var(--apkt-easings-ease-out-power-2)":"w3m-iframe-zoom-in 200ms var(--apkt-easings-ease-out-power-2)"}onHideIframe(){this.iframe.style.display="none",this.iframe.style.animation="w3m-iframe-fade-out 200ms var(--apkt-easings-ease-out-power-2)"}async syncTheme(){const t=V.getAuthConnector();if(t){const i=z.getSnapshot().themeMode,r=z.getSnapshot().themeVariables;await t.provider.syncTheme({themeVariables:r,w3mThemeVariables:F(r,i)})}}async updateFrameSizeForEmbeddedMode(){var r;const t=(r=this==null?void 0:this.renderRoot)==null?void 0:r.querySelector("div");await new Promise(n=>{setTimeout(n,300)});const i=this.getBoundingClientRect();t.style.width="100%",this.iframe.style.left=`${i.left}px`,this.iframe.style.top=`${i.top}px`,this.iframe.style.width=`${i.width}px`,this.iframe.style.height=`${i.height}px`,this.onShowIframe()}};S.styles=Q;B([y()],S.prototype,"ready",void 0);S=B([f("w3m-approve-transaction-view")],S);const J=R`
  a {
    border: none;
...
`;var x=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let p=class extends h{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return c`
      ...
      ></wui-input-text>
    `}};p.styles=[P,re];x([l()],p.prototype,"errorMessage",void 0);x([l({type:Boolean})],p.prototype,"disabled",void 0);x([l()],p.prototype,"value",void 0);x([l({type:Boolean})],p.prototype,"loading",void 0);x([l({attribute:!1})],p.prototype,"onKeyDown",void 0);p=x([f("wui-ens-input")],p);const ne=R`
  wui-flex {
    width: 100%;
  }
...
`;var b=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let u=class extends h{constructor(){var t;super(),this.formRef=G(),this.usubscribe=[],this.name="",this.error="",this.loading=w.state.loading,this.suggestions=w.state.suggestions,this.profileName=(t=$.getAccountData())==null?void 0:t.profileName,this.onDebouncedNameInputChange=I.debounce(i=>{i.length<4?this.error="Name must be at least 4 characters long":T.isValidReownName(i)?(this.error="",w.getSuggestions(i)):this.error="The value is not a valid username"}),this.usubscribe.push(w.subscribe(i=>{this.suggestions=i.suggestions,this.loading=i.loading}),$.subscribeChainProp("accountState",i=>{this.profileName=i==null?void 0:i.profileName,i!=null&&i.profileName&&(this.error="You already own a name")}))}firstUpdated(){var t;(t=this.formRef.value)==null||t.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){var t;super.disconnectedCallback(),this.usubscribe.forEach(i=>i()),(t=this.formRef.value)==null||t.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return c`
    ...
    </wui-flex>`}isAllowedToSubmit(t){var n;const i=(n=t.split("."))==null?void 0:n[0],r=this.suggestions.find(o=>{var s,a;return((a=(s=o.name)==null?void 0:s.split("."))==null?void 0:a[0])===i&&o.registered});return!this.loading&&!this.error&&!this.profileName&&i&&w.validateName(i)&&!r}async onSubmitName(t){try{if(!this.isAllowedToSubmit(t))return;C.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:_($.state.activeChain)===A.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t}}),await w.registerName(t),C.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:_($.state.activeChain)===A.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t}})}catch(i){Y.showError(i.message),C.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:_($.state.activeChain)===A.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t,error:I.parseError(i)}})}}onEnterKey(t){if(t.key==="Enter"&&this.name&&this.isAllowedToSubmit(this.name)){const i=`${this.name}${D.WC_NAME_SUFFIX}`;this.onSubmitName(i)}}};u.styles=ne;b([l()],u.prototype,"errorMessage",void 0);b([y()],u.prototype,"name",void 0);b([y()],u.prototype,"error",void 0);b([y()],u.prototype,"loading",void 0);b([y()],u.prototype,"suggestions",void 0);b([y()],u.prototype,"profileName",void 0);u=b([f("w3m-register-account-name-view")],u);const se=U`
