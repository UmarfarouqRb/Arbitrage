import{m as g,o as f,R as u,x as e,E as P,r as k,n as A}from"./index-3lbi0dXR.js";import{r as y,c as b,n as w}from"./index-B6cO4qdv.js";import"./index-DTxhk5Sw.js";import{H as x}from"./HelpersUtil-D1Lw2uMk.js";import{o as v}from"./if-defined-BEiUbVTn.js";import"./index-fCeIi6xQ.js";import"./index-CJHcgssA.js";const I=g`
  :host {
    display: block;
  }
...
`;var S=function(t,i,n,r){var o=arguments.length,a=o<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,n,r);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o<3?s(a):o>3?s(i,n,a):s(i,n))||a);return o>3&&a&&Object.defineProperty(i,n,a),a};let p=class extends f{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status="hide",this.view=u.state.view}firstUpdated(){this.status=x.hasFooter()?"show":"hide",this.unsubscribe.push(u.subscribeKey("view",i=>{this.view=i,this.status=x.hasFooter()?"show":"hide",this.status==="hide"&&document.documentElement.style.setProperty("--apkt-footer-height","0px")})),this.resizeObserver=new ResizeObserver(i=>{for(const n of i)if(n.target===this.getWrapper()){const r=`${n.contentRect.height}px`;document.documentElement.style.setProperty("--apkt-footer-height",r)}}),this.resizeObserver.observe(this.getWrapper())}render(){return e`
    ...
    </wui-flex>`}onNetworkHelp(){P.sendEvent({type:"track",event:"CLICK_NETWORK_HELP"}),u.push("WhatIsANetwork")}getWrapper(){var i;return(i=this.shadowRoot)==null?void 0:i.querySelector("div.container")}};p.styles=[I];S([y()],p.prototype,"status",void 0);S([y()],p.prototype,"view",void 0);p=S([b("w3m-footer")],p);const R=g`
  :host {
    display: block;
    width: inherit;
  }
...
`;var C=function(t,i,n,r){var o=arguments.length,a=o<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,n,r);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o<3?s(a):o>3?s(i,n,a):s(i,n))||a);return o>3&&a&&Object.defineProperty(i,n,a),a};const $=4;let h=class extends f{constructor(){super(...arguments),this.walletImages=[]}render(){const i=this.walletImages.length<$;return e`${this.walletImages.slice(0,$).map(({src:n,walletName:r})=>e`
          ...
          ></wui-wallet-image>
        `)}
    ${i?[...Array($-this.walletImages.length)].map(()=>e` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};h.styles=[k,O];C([w({type:Array})],h.prototype,"walletImages",void 0);h=C([b("wui-all-wallets-image")],h);const E=g`
  :host {
    width: 100%;
  }
...
`;var m=function(t,i,n,r){var o=arguments.length,a=o<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,n,r);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o<3?s(a):o>3?s(i,n,a):s(i,n))||a);return o>3&&a&&Object.defineProperty(i,n,a),a};const z={eip155:"ethereum",solana:"solana",bip122:"bitcoin",polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0};let l=class extends f{constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return this.dataset.size=this.size,e`
      <button
