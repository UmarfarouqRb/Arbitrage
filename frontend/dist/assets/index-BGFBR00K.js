import{p as g,j as C,k as w,m as k,r as $,o as m,x as d,O as l}from"./index-BqXcWhvD.js";import{n as x,c as f,r as v}from"./index-BoO9KiEv.js";import{o as z}from"./if-defined-DyAY53zS.js";import{e as O,n as _}from"./ref-D8SQPLZ7.js";const h=g({isLegalCheckboxChecked:!1}),u={state:h,subscribe(e){return w(h,()=>e(h))},subscribeKey(e,t){return C(h,e,t)},setIsLegalCheckboxChecked(e){h.isLegalCheckboxChecked=e}},E=k`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var b=function(e,t,c,s){var n=arguments.length,o=n<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,c):s,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,c,s);else for(var r=e.length-1;r>=0;r--)(i=e[r])&&(o=(n<3?i(o):n>3?i(t,c,o):i(t,c))||o);return n>3&&o&&Object.defineProperty(t,c,o),o};const j={lg:"md",md:"sm",sm:"sm"};let a=class extends m{constructor(){super(...arguments),this.inputElementRef=O(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const t=j[this.size];return d`
    ...
    `}dispatchChangeEvent(){var t;this.dispatchEvent(new CustomEvent("checkboxChange",{detail:(t=this.inputElementRef.value)==null?void 0:t.checked,bubbles:!0,composed:!0}))}};a.styles=[$,E];b([x({type:Boolean})],a.prototype,"checked",void 0);b([x({type:Boolean})],a.prototype,"disabled",void 0);b([x()],a.prototype,"size",void 0);a=b([f("wui-checkbox")],a);const P=k`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
